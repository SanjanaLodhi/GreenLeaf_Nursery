...
urlpatterns = [
    ...
    path('removecart/', views.minus_cart, name='removecart'),
    ...
    (template_name='changepassword.html',form_class=MyPasswordChangeForm,success_url='/passwordchangedone'),name='passwordchange'),
...
# user name = Sanjana password root@123